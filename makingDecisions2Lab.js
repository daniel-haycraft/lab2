...
//    if (nums[i] % 2 === 0){
//     evensArr = evensArr.concat(nums[i]);
...
//   console.log("D")
// }else{
// console.log(`lower than 59!:(, you have a ${score}%, failing grade!`)
// }
//Code Here
...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24,400,5,5,5,5];
// Do not edit the code above.
...
// making sure to use the length less than 7 (at first i put <= 7 but i realized that would include 7 of course. you do 7 - 1 because indexing starts at 7)
//Code Here
...
switch (letterGrade){
  case 'A':
    letterGrade = console.log("The student is doing excellently")
    break;
  case 'B':
    letterGrade = console.log("The student is doing well")
    break;
  case "B":
    letterGrade = console.log("The student is doing alright")
    break;
  case "E":
    letterGrade = console.log("The student is not doing very well")
    break;
  case "F":
    letterGrade = console.log("The student is failing")
    break;
  default: 
    console.log("N/A")
}
...
for (let i = 0; 100 >= i; i++){
  ...
  if (i % 3 === 0){
    ...
    console.log(`${i} this number wasn't divis. by 3 or 5`)
  }
  }
